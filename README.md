...
`NO_CHANGE_TETHERING_PERMISSION`, 2026-09-13 실측: docs/verification-log.md 열린 질문 0). 앱과 위젯은 그 상태를
**보여 주기만** 한다: `GET /api/hotspot` 과 `/api/status.hotspot`, 서버가 없을 때는 앱이 직접 인터페이스를 본다.
